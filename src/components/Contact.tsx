...
export default function Contact() {
  return (
    <section id="contact" className="py-16 md:py-24 px-6 md:px-12 bg-white transition-colors">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-6">
              <h3 className="text-3xl font-bold tracking-tight text-[#141414]">Let's build something scalable.</h3>
              ...
              <div className="flex flex-wrap gap-8">
                {socialLinks.map((link) => (
                  <a
                    key={link.name}
                    href={link.href}
                    className="flex items-center gap-2 text-xs uppercase font-bold tracking-widest text-[#141414] hover:text-gray-400 transition-colors"
                  >
                    {link.icon} {link.name}
                  </a>
                ))}
          ...
          <div className="flex flex-col gap-8 bg-gray-50 p-8 md:p-12 border border-gray-100">
            <div className="flex flex-col gap-2">
              <span className="text-[10px] uppercase tracking-widest font-bold text-gray-400">Current Status</span>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                <span className="text-lg font-bold tracking-tight text-[#141414]">Senior Software Engineer @ Wonderbiz</span>
              </div>
            </div>

            <div className="flex flex-col gap-2">
              <span className="text-[10px] uppercase tracking-widest font-bold text-gray-400">Timezone</span>
              <span className="text-lg font-bold tracking-tight text-[#141414]">IST (UTC+5:30)</span>
            </div>

            <motion.a
              whileHover={{ x: 10 }}
              href="mailto:prakashsewani1994@gmail.com"
              className="mt-auto flex items-center justify-between p-6 bg-[#141414] text-white text-xs uppercase font-bold tracking-widest group transition-colors"
            >
        ...
        <div className="mt-24 pt-12 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            <span className="text-[10px] uppercase tracking-widest font-bold text-gray-300">Built with</span>
