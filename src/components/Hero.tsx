...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-12 pt-24 pb-12 overflow-hidden bg-white dark:bg-[#0a0a0a] transition-colors">
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <h1 className="text-[14vw] md:text-[10vw] font-serif leading-[0.85] tracking-tighter italic text-[#141414] dark:text-white select-none">
            Prakash <br />
            Sewani
          </h1>
